...
internal static class Lang
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["toolbar.boost"] = "Amplify",
        ["toolbar.noise"] = "NF",
        ["toolbar.noise_tip"] = "Noise filter",
        ["toolbar.device"] = "Mic:",
        ["toolbar.device_default"] = "Default",
        ["toolbar.enable_tip"] = "Enable/disable microphone processing (device + filter + volume)",
        ["help.mic_title"] = "Microphone panel (above the log):",
        ["help.mic_desc"] = "Amplify + noise filter + volume — boosts a quiet mic (e.g. AirPods)",
    ...
    private static readonly Dictionary<string, string> De = new()
    {
        ...
        ["toolbar.boost"] = "Verstärken",
        ["toolbar.noise"] = "RF",
        ["toolbar.noise_tip"] = "Rauschfilter",
        ["toolbar.device"] = "Mikro:",
        ["toolbar.device_default"] = "Standard",
        ["toolbar.enable_tip"] = "Mikrofon-Bearbeitung ein/aus (Gerät + Filter + Lautstärke)",
        ["help.mic_title"] = "Mikrofon-Leiste (über dem Log):",
        ["help.mic_desc"] = "Verstärken + Rauschfilter + Lautstärke — hebt ein leises Mikro (z. B. AirPods)",
    ...
    private static readonly Dictionary<string, string> Ru = new()
    {
        ...
        ["toolbar.boost"] = "Усиление",
        ["toolbar.noise"] = "ШФ",
        ["toolbar.noise_tip"] = "Шумоподавление (фильтр)",
        ["toolbar.device"] = "Микрофон:",
        ["toolbar.device_default"] = "По умолчанию",
        ["toolbar.enable_tip"] = "Включить/выключить обработку микрофона (устройство + фильтр + громкость)",
        ["help.mic_title"] = "Панель микрофона (над логом):",
        ["help.mic_desc"] = "Усиление + шумоподавление + громкость — вытягивает тихий микрофон (напр. AirPods)",
